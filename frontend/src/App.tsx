...
function App() {
  ...
  console.log('🧪 TasksPage component:', TasksPage)
  console.log('🧪 About to create TasksPage element')
  
  const tasksPageElement = <TasksPage />
  console.log('🧪 TasksPage element created:', tasksPageElement)
